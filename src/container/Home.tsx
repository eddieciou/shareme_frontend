  ...
  return (
    <div className='flex bg-gray-50 md:flex-row flex-col h-screen duration-75 ease-out'>
      ...
      <div className='flex md:hidden flex-row'>
        ...
        <div
          className={`fixed w-4/5 bg-white h-screen overflow-y-auto shadow-md z-10 duration-500 ease-in-out ${
            togglesSidebar ? '-translate-x-0' : '-translate-x-full'
          }`}
        >
      ...
      <div className='pb-2 flex-1 h-screen overflow-y-scroll' ref={scrollRef}>
        <Routes>
          <Route path='/user-profile/:userId' element={<UserProfile loginUser={user} />} />
