...
const PinDetail = ({ user }: IPinDetail) => {
  const [pins, setPins] = useState<Array<TPin> | null>(null);
      ...
      {pins ? (
        <>
          <h2 className='text-center font-bold text-2xl mt-8 mb-4'>
            {pins.length > 0 ? 'More like this' : 'No more like this'}
          </h2>
